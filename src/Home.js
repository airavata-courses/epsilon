...
const Home = () => {
  ...
  const ResponseGoogle = (response) => {
    axiosApiCall(
      `${process.env.REACT_APP_API_GTW}/auth/ms1/google/`,
      "POST",
      response
    )
      .then((res) => {
          ...
          <ThemeProvider theme={theme}>
            ...
            <Container component="main" maxWidth="md" sx={{ marginTop: 8 }}>
              ...
              >
                ...
                the radar receiver after hitting precipitation, compared to a
                reference power density at a distance of 1 meter from the radar
                antenna.
              </Typography>
            </Container>

...
exports.isAuthenticated = async function (req, res, next) {
    try {
        let payload = verifyJWTToken(req.headers.authorization);
        if (!payload) {
            return res.errorBhejdo(HttpStatus.UNAUTHORIZED, { success: false, msg: "Could not identify user." });
        }
